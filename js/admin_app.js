require(['app_bar/app_bar', 'classes/classes', 'task_stats/task_stats',
    ...
    'schedule_editor/schedule_editor', 'course_editor/course_editor',
    'services', 'permission', 'utils'],
    function() {

  angular.module('AppModule', ['AppBarModule', 'ClassesModule',
      'TaskStatsModule', 'UsersModule', 'LearningRecordsModule',
      'ScheduleEditorModule', 'CourseEditorModule', 'ServicesModule',
      'PermissionModule', 'UtilsModule'])
